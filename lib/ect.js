/*!
 * ECT CoffeeScript template engine v0.4.1
	...
	var	ECT = function (options) {
		...
		var
			...
			parse = function (template) {
				var
					...
					indentChar, indentation = '', indent = false, indentStack = [], indentStackPointer = -1, baseIndent, lines, j, extended;
		...
		TemplateContext.prototype.load = function (template) {
			...
			if (ect.options.cache && cache[template]) {
				...
				var extExp = new RegExp(options.ext + '$');
